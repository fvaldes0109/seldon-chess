...
public class Perft
{
    ...
    public void InitialPosition() {
        ...
        CheckResult(fen, new int[]{ 20, 400, 8902, 197281 });
    }
    ...
    public void Position2() {
        ...
        CheckResult(fen, new int[]{ 48, 2039, 97862 });
    }
    ...
    public void Position3() {
        ...
        CheckResult(fen, new int[]{ 14, 191, 2812, 43238, 674624 });
    }
    ...
    public void Position4() {
        ...
        CheckResult(fen, new int[]{ 6, 264, 9467, 422333 });
    ...
    public void Position5() {
        ...
        CheckResult(fen, new int[]{ 44, 1486, 62379 });
    }
    ...
    public void Position6() {
        ...
        CheckResult(fen, new int[]{ 46, 2079, 89890 });
    }

    private void CheckResult(string fen, int[] results) {
        
        for (int i = 0; i < results.Length; i++) {
            Assert.AreEqual(PositionsCounter.Total(fen, i + 1), results[i]);
        }
    }

    private void CheckSingleResult(string fen, int depth, int result) {
        Assert.AreEqual(PositionsCounter.Total(fen, depth), result);
    }
}
